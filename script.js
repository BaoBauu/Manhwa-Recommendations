...
carousel.addEventListener('scroll', () => {
  ...
  if (carousel.scrollLeft <= firstReal.offsetLeft - carousel.offsetLeft - 1) {
    carousel.scrollLeft = lastReal.offsetLeft - carousel.offsetLeft + 1;
  }
  
  if (
    carousel.scrollLeft >=
    lastReal.offsetLeft - carousel.offsetLeft + lastReal.offsetWidth - 1
  ) {
    carousel.scrollLeft = firstReal.offsetLeft - carousel.offsetLeft + 1;
  }
});
